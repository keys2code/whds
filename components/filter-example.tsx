...
import { IconBan, IconBell, IconBuilding, IconClock, IconFileAlert, IconFilter, IconFilterOff, IconGlobe, IconMail, IconPhone, IconStar, IconUserCheck, IconUsers, IconUserX } from '@tabler/icons-react'
          ...
          options: [
            {
              ...
              label: "To Do",
              icon: (
                <IconClock  className="stroke-violet-500" />
              ),
            },
            {
              value: "in-progress",
              label: "In Progress",
              icon: (
                <IconFileAlert  className="stroke-yellow-500" />
              ),
            },
          ],
        },
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              label: "Standard",
              icon: (
                <IconBuilding  className="size-3 text-blue-500" />
              ),
            },
            {
              value: "trial",
              label: "Trial",
              icon: (
                <IconClock  className="size-3 text-gray-500" />
              ),
            },
          ],
        },
